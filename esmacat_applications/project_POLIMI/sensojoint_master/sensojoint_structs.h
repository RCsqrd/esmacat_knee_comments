...
struct  adaptive_traj_terms {
    // Parameters related to the trajectoy;
        double adapt_velocity_setpoint;
        double adapt_pos_setpoint;
//        double error_traj;
        double adaptive_velocity_max;
    // Treshold parameters
        double max_position_peak;
        double min_position_peak;
};
