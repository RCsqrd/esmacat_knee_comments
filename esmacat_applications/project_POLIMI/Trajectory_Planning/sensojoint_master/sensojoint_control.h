...
private:
    ...
    double derating_param_time_to_arrive_75p_in_msec = 10.0;   // Time in milliseconds to reach 75% of desired setpoint
    ...
    float max_torque_control_input = 45000;     // max value allowed as torque input
...
public:
    ...
    esmacat_err impedance_control(float setpoint_radians,float setpoint_vel,float gravity_torque_mNm, float elapsed_time_ms);
