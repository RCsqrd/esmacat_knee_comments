...
#define EXERCISE_AMPLITUDE 70*(M_PI/180) // 13*M_PI/36 = 65 deg
#define EXERCISE_START 0      // M_PI/36 5 deg M_PI/18 = 10deg
#define POS_OFFSET M_PI*345/180

#define SIGMA_EX_DURATION 4000.0
#define discretization_factor 100

#define APPLICATION_TIMEOUT_MS 120*15000 // = 1 min valentina 3min
/*****************************************************************************************
 *********************** CLASSES*********************************************************
 ****************************************************************************************/
/**
...
public:
    ...
    //freeze
    double Ks_freeze = 2000.0*Nm_to_mNm; //era 25
    double Kd_freeze = 2.5*Nm_to_mNm;
    ...
    double P1 = 0.0;
  //double P1 = sensojoint_shared_memory.data->rom/pow(EXERCISE_DURATION/2,(P3+P5)); //instead pf EXERCISE_AMPLITUDE
