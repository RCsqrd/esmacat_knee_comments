...
private:
    ...
    esmacat_loadcell_interface ecat_li; /**< create your Esmacat Loadcell Interface slave object */ //I CHANGED THE OBJECT NAME FROM ecat_md to ecat_li
    bool led_on_off_status; /**< indicates if led is on or off*/
public:
