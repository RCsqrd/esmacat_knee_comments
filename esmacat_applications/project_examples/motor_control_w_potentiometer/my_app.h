...
private:
    ...
    esmacat_analog_input_slave ecat_ai; /**< create your Esmacat Analog Input slave object */
    esmacat_motor_driver ecat_md; /**< create your Esmacat Motor Driver slave object */
public:
